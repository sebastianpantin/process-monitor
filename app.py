                        ...
                        html.Div(className='row',  # Define the row element
                               children=[
                                  ...
                                  children = [
                                        ...
                                        html.P('''Visualizes resource usage of a process and the system'''),
                                        html.P('''Please enter the PID of the process you want to monitor (default is this app)'''),
                                        dcc.Input(id='input_pid', type='number', placeholder='Input PID', debounce=True, value=os.getpid()),
                                  ...
                                  html.Div(className='columns div-for-charts bg-grey',
                                    children = [
                                        ...
                                        dcc.Graph(
                                            ...
                                            animate=True,
                                            figure=go.Figure(data = [go.Scatter(x=list(reversed(range(frame_len))), y = [0], name=f"Scatter", mode='lines', line_shape='spline')],
                                             layout=go.Layout(xaxis=dict(range=[frame_len, 0]), yaxis=dict(ticksuffix='MB', rangemode='tozero'))
...
def update_extendData(n_intervals, value):
    process = psutil.Process(value) or psutil.Process(os.getpid())
